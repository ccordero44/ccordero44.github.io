...
(function ($) {
    ...
    $.fn.richText = function (options) {
        ...
        var settings = $.extend({
            ...
            template: true,
            templates : ["Action/Resolution Plan",
                "PAPER",
                "SIU Referral",
                "Round Table Liability",
                "Round Table Coverage",
                "Supervisor Initial BI Demand Review",
                "Time Limited Demand Review"
            ],
            fontColor: true,
            bgColor: true,
            fontSize: true,
            ...
            colors: {"rgb(0, 0, 0)": "Black",
                "rgb(153, 51, 0)": "Sangria",
                "rgb(51, 51, 0)": "British Racing Green",
                "rgb(0, 51, 0)": "Dark Green",
                "rgb(0, 51, 102)": "Prussian Blue",
                "rgb(0, 0, 128)": "Navy",
                "rgb(51, 51, 153)": "Blue Gem",
                "rgb(51, 51, 51)": "Night Rider",
                "rgb(128, 0, 0)": "Maroon",
                "rgb(255, 102, 0)": "Safety Orange",
                "rgb(128, 128, 0)": "Olive",
                "rgb(0, 128, 0)": "Green",
                "rgb(0, 128, 128)": "Teal",
                "rgb(0, 0, 255)": "Blue",
                "rgb(102, 102, 153)": "Scampi",
                "rgb(128, 128, 128)": "Grey",
                "rgb(255, 0, 0)": "Red",
                "rgb(255, 153, 0)": "Orange Peel",
                "rgb(153, 204, 0)": "Citrus",
                "rgb(51, 153, 102)": "Eucalyptus",
                "rgb(51, 204, 204)": "Medium Turquoise",
                "rgb(51, 102, 255)": "Neon Blue",
                "rgb(128, 0, 128)": "Purple",
                "rgb(153, 153, 153)": "Nobel",
                "rgb(255, 0, 255)": "Magenta",
                "rgb(255, 204, 0)": "Tangerine Yellow",
                "rgb(255, 255, 0)": "Yellow",
                "rgb(0, 255, 0)": "Lime",
                "rgb(0, 255, 255)": "Aqua",
                "rgb(0, 204, 255)": "Deep Sky Blue",
                "rgb(153, 51, 102)": "Lipstick",
                "rgb(192, 192, 192)": "Silver",
                "rgb(255, 153, 204)": "Carnation Pink",
                "rgb(255, 204, 153)": "Peach-Orange",
                "rgb(255, 255, 153)": "Canary",
                "rgb(204, 255, 204)": "Honeydew",
                "rgb(204, 255, 255)": "Light Cyan",
                "rgb(153, 204, 255)": "Columbia Blue",
                "rgb(204, 153, 255)": "Mauve",
            ...
            translations: {
                ...
                'addBackColor': 'Add background color',
        ...
        var $editor,
            ...
            $btnSpell = $('<a />', {
                class: "richText-btn",
                "data-command": "spellcheck",
                "title": settings.translations.spell,
                html: '<span class="fas fa-spell-check"></span>'
            }),
            $btnBold = $('<a />', {
                class: "richText-btn",
                "data-command": "bold",
            ...
            $btnFontColor = $('<a />', {
             ...
             $btnBGColor = $('<a />', {
                class: "richText-btn",
                "title": settings.translations.addBackColor,
                html: '<span class="fas fa-palette"></span>'
            }), // background color
            $btnFontSize = $('<a />', {
                class: "richText-btn",
            ...
            $btnTemplates = $('<a />', {
                ...
                html: '<span class="fas fa-ellipsis-h"></span>',
                'title': settings.translations.templates
            }); // code
        ...
        /* list dropdown for templates */
        var templates = settings.templates;
        var $templates = $dropdownList.clone();
            for (var i = 0; i < templates.length; i++) {
            $templates.append($('<li />', {html: '<a data-command="'+templates[i]+'" data-option="' + templates[i] + '">' + templates[i] + '</a>'}));
            }
        $btnTemplates.append($dropdownOuter.clone().append($templates.prepend($dropdownClose.clone())));
        
        /* list dropdown for font sizes */
        //var fontSizes = [24, 18, 16, 14, 12];
        var fontSizes = [8, 10, 12, 14, 18, 24, 36],
        optSizes = [1, 2, 3, 4, 5, 6, 7];
        ...
        for (var i = 0; i < fontSizes.length; i++) {
          //  $fontSizes.append($('<li />', {html: '<a style="font-size:' + fontSizes[i] + 'px;" data-command="fontSize" data-option="' + fontSizes[i] + '">' + settings.translations.text + ' ' + fontSizes[i] + 'px</a>'}));
                $fontSizes.append($('<li />', {html: '<a style="font-size:' + fontSizes[i] + 'pt;" data-command="fontSize" data-option="' + optSizes[i] + '">' + ' ' + fontSizes[i] + 'pt</a>'}));
        }
        ...
        $btnBGColor.append($dropdownOuter.clone().append($bgColors.prepend($dropdownClose.clone())));
        ...
        function init() {
            ...
            /* text formatting */
            if (settings.spell === true) {
                $toolbarList.append($toolbarElement.clone().append($btnSpell));
            }
            ...
            /* background colors */
            if (settings.bgColor === true) {
                $toolbarList.append($toolbarElement.clone().append($btnBGColor));
            }
            /* uploads */
            ...
            if (settings.template === true) {
                $toolbarList.append($toolbarElement.clone().append($btnTemplates));
            }
            ...
            $editor.append(
                $('<div />', {class: 'richText-toolbar'})
                    ...
                    .append($('<a />', {
                        class: 'richText-copy',
                        html: '<span class="far fa-copy"></span>',
                        'title': settings.translations.copy
                    }))
                   
                    .append($('<a />', {
                        class: 'richText-delete',
                        html: '<span class="far fa-trash-alt"></span>',
                        'title': settings.translations.delete
                    }))
                   .append($('<a />', {
                        class: 'richText-siumail',
                        html: '<span class="far fa-envelope"></span>',
                        'title': settings.translations.siumail
                    }))
        ...
        // copy / delete
        settings.$editor.find('.richText-copy, .richText-delete').on('click', function () {
            var $this = $(this);
            if ($this.hasClass("richText-copy")) {
                copyToClip($('.richText-editor').html());
            } else if ($this.hasClass("richText-delete")) {
                $('.richText-editor').html('<div><font size="3" face="Arial"><br></font></div>');
                $('.richText-editor').focus();
                $('.richText-siumail').hide();
            }
        });
        // email SIU note
                var html;
                
        settings.$editor.find('.richText-siumail').on('click', function () {
           SIUcopyToClip($('.richText-editor').html());
        ...
        settings.$editor.find('.richText-editor').on('input change blur keydown keyup', function (e) {
            ...
            var arry = ["SIU Referral", "Claim Number:", "Named Insured:", "Facts of Loss:", "Indicator(s) of Potential Fraud:"];
            string.indexOf(arry[0].toLowerCase()) <= 0 || string.indexOf(arry[1].toLowerCase()) <= 0 || string.indexOf(arry[2].toLowerCase()) <= 0 || string.indexOf(arry[3].toLowerCase()) <= 0 || string.indexOf(arry[4].toLowerCase()) <= 0 ? $('.richText-siumail').hide() : $('.richText-siumail').show();
        ...
        settings.$editor.find('.richText-toolbar a[data-command]').on('click', function (event) {
            ...
            if ($editor.length > 0 && id === editorID && (!$button.parent("li").attr('data-disable') || $button.parent("li").attr('data-disable') === "false")) {
                ...
                if (command === "Action/Resolution Plan") {
                   $('.richText-editor').html('<div><b><font size="3">Action Completed/Next Steps</font></b></div><div><font size="3"><br></font></div><div><b><font size="3"><br></font></b></div><div><b><font size="3">Resolution Plan</font></b></div><div><font size="3">Coverage:&nbsp;</font></div><div><font size="3">Liability:&nbsp;</font></div><div><font size="3">Reserves:&nbsp;</font></div>');
                }
                if (command === "Round Table Liability") {
                   $('.richText-editor').html('<div style="text-align: center;"><b><font size="3">Round Table (Liability)</font></b></div><div style="text-align: left;"><font size="3"><b>State</b>:&nbsp;</font></div><div style="text-align: left;"><font size="3"><b>Coverage</b>:&nbsp;</font></div><div style="text-align: left;"><font size="3"><b>Negligence Standard</b>:&nbsp;</font></div><div style="text-align: left;"><font size="3"><b>Liability</b>:&nbsp;</font></div><div style="text-align: left;"><font size="3"><b>Current Reserve</b>:&nbsp;</font></div><div style="text-align: left;"><font size="3"><b>Reserve Change</b>:&nbsp;</font></div><div style="text-align: left;"><font size="3"><b>Recommendation</b>:&nbsp;</font></div>');
                }
                if (command === "Round Table Coverage") {
                   $('.richText-editor').html('<div style="text-align: center;"><b><font size="3">Round Table (Coverage)</font></b></div><div style="text-align: left;"><font size="3"><b>State</b>:&nbsp;</font></div><div style="text-align: left;"><font size="3"><b>DOL</b>:&nbsp;</font></div><div style="text-align: left;"><font size="3"><b>Date Reported</b>:&nbsp;</font></div><div style="text-align: left;"><font size="3"><b>Reported By</b>:&nbsp;</font></div><div style="text-align: left;"><font size="3"><b>Policy Term</b>:&nbsp;</font></div><div style="text-align: left;"><font size="3"><b>Coverage</b>:&nbsp;</font></div><div style="text-align: left;"><font size="3"><b>Reservation of Rights Sent</b>:&nbsp;</font></div><div style="text-align: left;"><font size="3"><b>Notes</b>:&nbsp;</font></div><div style="text-align: left;"><font size="3"><b>Recommendation</b>:&nbsp;</font></div>');
                }
                if (command === "PAPER") {
                    $('.richText-editor').html(`<div title="Policy\n1. Is the policy in force?\n2. What is the policy term/effective dates?\n3. Has there been time out of force or a lapse in coverage?\n4. Have there been changes to the policy within 30 days of the loss?\n5. Review scheduled driver(s).\n6. Review scheduled vehicle(s).\n7. Review coverages and policy limits that may be applicable.\n8. Are there any rescindable issues? (See the Policy Rescission process for more information)"><font size="3"><b>P</b>:&nbsp;</font></div><div title="Automobile\n1. Does the involved vehicle fall within the Insuring Agreement?\n2. Does the involved vehicle meet the definition of a described, owned, non-owned, additional, replacement, or temporary substitute automobile, as defined in the policy?\n3. If the involved vehicle was recently purchased, when did the Named Insured take title or possession of the vehicle?\n4. Did the Named Insured notify the Company of the new purchase within the required time?\n5. If the involved vehicle is an additional vehicle, does the Named Insured insure all other owned vehicles with us?\n6. If the involved vehicle was being used as a temporary substitute, waht was the status of the described/covered car at the time of loss? Was it out of service? If so, for what dates? "><font size="3"><b>A</b>:&nbsp;</font></div><div title="Person Seeking Coverage\n1. Does the person seeking coverage meet the definition of  &quot;Persons Insured&quot; or &quot;Insured Persons&quot;, as defined in the policy?\n2. Is the person seeking coverage a listed driver on the policy?\n3. Is the person seeking coverage an excluded driver on the policy?\n4. Is the person seeking coverage a resident of the Named Insured's household but NOT listed on the policy?\n5. Does the person seeking coverage have regular and frequent use of the covered vehicle? (See policy definitions)\n6. If required, did the person seeking coverage have permission (&quot;express&quot; and/or &quot;implied&quot;) to operate the vehicle?\n7. If required, did the permissive user operate the vehicle within the scope of permission?"><font size="3"><b>P</b>:&nbsp;</font></div><div title="Exclusions\n1. Do any policy exclusions apply?\n2. Ask, &quot;What was the purpose of your trip?&quot;\n3. Review the exclusions section under the coverage part you are reviewing. Exclusions change throughout the policy.\n4. The most common exclusions are:\n\ta. Use of the vehicle for delivery (DoorDash, Uber Eats, Panera, Domino's, Amazon, flower shop, Wal-Mart, etc.).\n\tb. Use of the vehicle for a Transportation Network Company/Platform (i.e. Uber/Lyft).\n\tc. Use of the vehicle for a private company (i.e. transporting a patient for dialysis).\n\td. Suspended, revoked, restricted, or no Driver's License."><font size="3"><b>E</b>:&nbsp;</font></div><div title="Recovery/Reimbursement\n1. Does subrogation apply?\n2. Does our policy apply as primary, excess, or pro-rata (our share of damages)?\n3. Are we seeking remibursement from the owner/operator of an Uninsured or Underinsured Motor Vehicle?\n4. Are we seeking reimbursement from another at-fault party (comparative negligence, joint/several liability)?\n5. Have we made sure to include claims for injuries to passengers in our vehicle for recovery as applicable?"><font size="3"><b>R</b>:&nbsp;</font></div>`);
                }
                if (command === "SIU Referral") {
                    $('.richText-editor').html('<div><b><font size="3">SIU Referral</font></b></div><div><font size="3">Claim Number:&nbsp;</font></div><div><font size="3">Named Insured:&nbsp;</font></div><div><font size="3">Facts of Loss:&nbsp;</font></div><div><font size="3">Indicator(s) of Potential Fraud:&nbsp;</font></div>');
                    $('.richText-siumail').show();
                }
                if (command === "Supervisor Initial BI Demand Review") {
                    $('.richText-editor').html('<div><b><font size="3">Supervisor Initial BI Demand Review</font></b></div><div><ul><li><font size="3">Date demand received:&nbsp;</font></li><li><font size="3">Review due by:&nbsp;</font></li><li><font size="3">Injured party:&nbsp;</font></li><li><font size="3">Demand dated:&nbsp;</font></li><li><font size="3">Venue:&nbsp;</font></li><li><font size="3">Demand response due:&nbsp;</font></li><li><font size="3">Significant to Note:&nbsp;</font></li></ul></div>');
                }
                if (command === "Time Limited Demand Review") {
                    $('.richText-editor').html('<div><b><font size="3">Time Limited Demand Review</font></b></div><div><ul><li title="List the policy limits, known coverage issues, whether we have sent a coverage letter, whether the policy was rescinded, or whether there are no coverage issues."><font size="3">Coverage:&nbsp;</font></li><li title="Describe the policy holder’s liability in a range, including strengths and weaknesses, and percentage chance likely of a defense verdict.  You may consider the jurisdiction’s comparative negligence and/or joint and several liability when assessing liability."><font size="3">Liability:&nbsp;</font></li><li title="For auto claims, your description should include points of impact and the damages, with photos of both vehicles on file, etc. For non-auto claims, advise regarding the facts of loss and mechanism for injury."><font size="3">Impact Severity:&nbsp;</font></li><li title=" County and venue type – Also, do the claimant’s demographics or other sympathetic circumstances (a minor, for example) make the claimant a likely candidate for a high jury verdict?"><font size="3">Venue:&nbsp;</font></li><li><font size="3">Demand Amount:&nbsp;</font></li><li title="Example, Holt, Stowers, McDill – each venue has different requirements for responding to the demand."><font size="3">Demand Type:&nbsp;</font></li><li title="List all demand stipulations or conditions.  Include an explanation of how we will achieve meeting the stipulations or conditions.  If there is a stipulation we may not be able to meet, describe such stipulation or condition."><font size="3">Demand Stipulations/Conditions:&nbsp;</font></li><li title="Yes/No, Should an excess letter be sent to the insured?"><font size="3">Excess Demand:&nbsp;</font></li><li title="Do we have accurate information for the insured? Did we send the insured the demand letter? Call the insured to inform the insured of the demand and advise of our response."><font size="3">Insured Notified:&nbsp;</font></li><li title="Date stipulated by case law and outlined by claimant’s counsel.  You must take care to follow-up with leadership to get a response to the demand prior to the due date – calendar the due date."><font size="3">Due Date:&nbsp;</font></li><li title="5 days to review a demand or earlier if less than 5 days’ notice."><font size="3">Our Evaluation Due Date:&nbsp;</font></li><li title="Is there Medicare involvement? Or any other mandatory lien, such as child support? If we are dealing with a short demand time, we may need to discuss with defense counsel how to best protect our obligations under the Medicare Secondary Payer Act."><font size="3">Medicare and/or other liens:&nbsp;</font></li></ul></div>');
                }
                if (command === "toggleCode") {
                  ...
                  //if (command === "fontSize" ) console.log(window.getComputedStyle($(document.getSelection().anchorNode.parentNode)[0]).fontSize+ " size font selected");
                  //if (command === "fontName" ) console.log(window.getComputedStyle($(document.getSelection().anchorNode.parentNode)[0]).fontFamily+ " font selected"); 
        ...
        function focusNextElement () {
            ...
            var focussableElements = 'a:not([disabled]):not(.richText-btn,.richText-templates,.richText-undo,.richText-redo,.richText-help), button:not([disabled]), input:not([disabled]), select:not([disabled]), textarea:not([disabled]), [tabindex]:not([disabled]):not([tabindex="-1"])';
        ...
        function formatText(command, option, editorID) {
            ...
            if (command === "heading" && getSelectedText()) {
               ...
               var html = (settings.useSingleQuotes ? "<span style='font-size:" + option + "pt;'>" + selection + "</span>" : '<span style="font-size:' + option + 'pt;">' + selection + '</span>');
               selectText(getSelection().getRangeAt(0).commonAncestorContainer.parentNode, html);
       ...
       */
        ...
        $(getSelection().getRangeAt(0).commonAncestorContainer.parentNode).text('');
...
*/
        ...
        function toggleCode(editorID) {
            ...
            if ($editor.find('.richText-editor').is(":visible")) {
                ...
                $('.richText-toolbar').find('.richText-btn, .richText-templates').each(function () {
        ...
        function fixFirstLine() {
            if ($editor && !$editor.find(".richText-editor").html()) {
                ...
                if (settings.useParagraph !== false) {
                    ...
                    $editor.find(".richText-editor").html('<div><font size="3" face="Arial"><br></font></div>');
                }
            } else {
...
function SIUcopyToClip(str) {
  function listener(e) {
    ...
    var clipboardData = e.clipboardData;
      ...
      html = html.replaceAll('</div><div>', '%0A');
      html = html.replaceAll('<div>', '');
      html = html.replaceAll('</div>', '');
      html = html.replace('<b>', '');
      html = html.replace('</b>','%0A');
      html = html.replaceAll('&nbsp;', '%0A');
      //document.location.href = mailtoURL('SIU@producersnational.com', 'SIU Referral',html);
    document.location.href = 'mailto:SIU@producersnational.com?subject=SIU%20Referral&body=' + html;
  }
  document.addEventListener("copy", listener);
  document.execCommand("copy");
